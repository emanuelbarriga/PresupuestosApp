# OCR Extraction Specification — V2

> Capability: `ocr-extraction` · Change: `ocr-gemini-integration` · Version: 2 · Date: 2026-07-16
...
- `@google/genai` — server-side Gemini SDK (MUST be added)
- `firebase-admin/storage` — `getStorage()` / `getAdminStorage()` (already in project)
